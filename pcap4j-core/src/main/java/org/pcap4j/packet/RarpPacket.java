 ...
 * @since pcap4j 0.9.1
 */
public final class RarpPacket extends AbstractPacket {

  /** */
  private static final long serialVersionUID = -7754807127571498700L;

  private final RarpHeader header;
   ...
   * @param offset offset
   * @param length length
   * @return a new ReverseArpPacket object.
   * @throws IllegalRawDataException if parsing the raw data fails.
   */
  public static RarpPacket newPacket(byte[] rawData, int offset, int length)
      throws IllegalRawDataException {
    ByteArrays.validateBounds(rawData, offset, length);
    return new RarpPacket(rawData, offset, length);
  }

  private RarpPacket(byte[] rawData, int offset, int length) throws IllegalRawDataException {
    this.header = new RarpHeader(rawData, offset, length);
  }

  private RarpPacket(Builder builder) {
    if (builder == null
    ...
    this.header = new RarpHeader(builder);
  }

  @Override
  public RarpHeader getHeader() {
    return header;
  }
  ...
  /** @author Sandor Szabo, by the work of Kaito Yamada */
  public static final class Builder extends AbstractBuilder {
    ...
    private Builder(RarpPacket packet) {
    ...
    @Override
    public RarpPacket build() {
      return new RarpPacket(this);
    }
  }
   ...
   */
  public static final class RarpHeader extends AbstractHeader {
    ...
    private RarpHeader(byte[] rawData, int offset, int length) throws IllegalRawDataException {
      if (length < ARP_HEADER_SIZE) {
        StringBuilder sb = new StringBuilder(200);
        sb.append("The data is too short to build a RARP header(")
    ...
    private RarpHeader(Builder builder) {
    ...
    public boolean equals(Object obj) {
      ...
      RarpHeader other = (RarpHeader) obj;
